...
public class FormularioProducto extends AppCompatActivity {
    ...
    BaseDeDato conexion = new BaseDeDato(this);
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    if (conexion.InsertProducto(datos)) {
                        Toast.makeText(FormularioProducto.this, "¡Producto insertado satisfactoriamente!", Toast.LENGTH_SHORT).show();
                        Intent lu = new Intent(FormularioProducto.this, recycler_productos.class);
                        startActivity(lu);
                    }
                    else{

            ...
            public void onClick(View view) {
                ...
                if ( nombre && apellido && correo && usuario && clave && tipo && estado && pregunta && respuesta){
                    ...
                    if (conexion.InserTradicional(datos)) {
                        Toast.makeText(FormularioUsuario.this, "Usuario registrado satisfactoriamente!", Toast.LENGTH_SHORT).show();
                        Intent lu = new Intent(FormularioUsuario.this, recycler_Usuario.class);
                        startActivity(lu);
                    }
                    else{
